...
def main() -> None:
    ...
    ap.add_argument("--scenario", choices=("city", "arterial"), default="city",
                    help="road environment to run (default: city)")
    args = ap.parse_args()
    ...
    if args.scenario == "city":
        ...
        simulator_cls = CitySimulator
    else:
        from ..sim.arterial import ArterialSimulator
        simulator_cls = ArterialSimulator
    ...
    sim = simulator_cls(seed=args.seed)
